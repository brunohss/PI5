...
class PrintSenseEmulatorHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        elif parsed_path.path == "/api/calibration":
...
def run_server(port=8080):
    ...
    print("   GET  /api/config         - Obter configuração atual")
    print("   POST /api/config         - Salvar dados de configuração")
    print("   GET  /api/calibration    - Obter dados de calibração")
    print("   POST /api/calibration    - Salvar dados de calibração")
    print("   GET  /api/system         - Obter dados do sistema")
    print("   POST /api/system         - Salvar dados do sistema\n")
